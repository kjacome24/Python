...
class User:
    ...
    def __init__(self,name, email):
        self.name = name
        self.email = email 
        # self.account = Bank_account.BankAccount(balance=0,interest_rate=0.02)
        self.account = [Bank_account.BankAccount(balance=0,interest_rate=0.02)] #This is setting the stage about the variable account being a list and the original account[0]
    ...
    def creationofaccount(self,balance=0,interest_rate=0):##By defoult when u create a user a bank account will be created but u can also add more: 
        self.account.append(Bank_account.BankAccount(balance=0,interest_rate=0.02))
        return self
...
###############
Bank_account.BankAccount.show_instances()
